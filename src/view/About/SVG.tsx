...
function SvgImg() {
  return (
    <svg version="1.1"
      ...
      xmlns="http://www.w3.org/2000/svg" >
      <image href="https://avatars.githubusercontent.com/u/44738166?s=400&u=1567f6c32384e98c343f17e848e5c6e96d9f479f&v=4" x="0" y="0" height="40" width="50"/>
    </svg>
  )
}
function Font() {
  ...
  return (
    <>
      <svg width={400}  viewBox="-20 -20 400 400"
        xmlns="http://www.w3.org/2000/svg" version="1.1">
        <text fontFamily="Super Sans">My text uses Super Sans</text>
      </svg>
    </>
  )
}
