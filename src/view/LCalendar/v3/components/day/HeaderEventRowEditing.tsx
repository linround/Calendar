...
import style from './style/headerEventRowEditing.module.less'
...
export function HeaderEventRowEditing(props:React.PropsWithChildren<IProps>) {
  const {
    segments,
    slots,
    days,
  ...
  return (
    <div
      className={style.headerEventRowEditing}
